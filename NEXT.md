...
- **[지금/화면]** **전투를 끝까지 본다.** 공격·서버 문구·대상 체력은 붙었는데, **때리는 장면을 확인하기가 어렵다** — 말벌이 돌아다녀 정면에 서 있질 않는다. 가만히 있는 괴물(`PathQualifer` 고정)을 하나 더 세우고, 체력이 줄어드는 것을 눈으로 확인한다. 죽은 뒤 떨어지는 물건은 바닥 아이템을 못 읽어서 아직 못 본다
