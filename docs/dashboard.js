(function () {
  ...
  var labels = { overview: "대시보드", system: "시스템 지도", flows: "기능 흐름", delivery: "개발·지식 그래프", world: "월드 지도", abilities: "기술·마법", items: "아이템 도감", knowledge: "게임 데이터", operations: "운영·유지보수", prototypes: "화면 실험실" };
  var category = "all";
  var searchQuery = "";
