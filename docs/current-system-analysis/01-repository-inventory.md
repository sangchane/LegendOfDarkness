...
|---|---|---|---|
| `FallenDev/Spark` | `master` / `848c8800a8a1` | DA 클라이언트 실행·주소 변경 런처 | 있음 |
| `FallenDev/DAGL` | `main` / `0d3b434e96c8` | 7.41 클라이언트 구조를 C#으로 옮긴 대형 라이브러리/역공학 자료 | 없음 |
| `FallenDev/Arbiter` | `main` / `42739fb5ac10` | 패킷 프록시·분석기 | 있음 |
| `FallenDev/SleepHunter4` | `master` / `33ae548b9119` | 메모리 기반 자동화 도구와 업데이터 | 있음 |
| `FallenDev/dark-ages-ts` | `main` / `76aa34ea85af` | Phaser/Svelte 클라이언트와 TypeScript 서버 | 있음 |
...
| `wren11/da` | `main` / `834551b47207` | C++ 클라이언트 후킹·패킷 캡처·자동화 | 없음 |
| `wren11/Dark-Ages-AI-Bot` | `main` / `c5ac73b8a62b` | C++20 DLL 주입형 봇/오버레이 실험 | 없음 |
| `wren11/ETDA` | `master` / `a404ba6b49c7` | 네이티브 DLL + C# 메모리 기반 봇 | 없음 |
| `wren11/DADataViewer` | `master` / `afeeafc3c0ab` | 아이템·스킬·마법·몬스터·효과·음원 뷰어 | 있음 |
| `wren11/Archivist` | `master` / `0e9835148ac8` | 아카이브 도구 UI 골격, 실제 기능 TODO | 있음 |
