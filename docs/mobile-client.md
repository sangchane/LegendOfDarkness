...
**직업 기술 동작**은 `python3 scripts/build-client-motions.py` 가 부위마다 뽑는다 — `mb001d.png`(몸의 무도가
동작)처럼 부위 이름 끝에 파일 글자. 칸 수는 b 14 · c 30 · d 18 · e 36 · f 12(`skill.tbl` 이 빈틈없이 채우는 만큼).
