...
구조는 원작(영문)이 정답지다 — `data/game-data/abilities.json` 613개에는 무엇을 배워야
무엇이 열리는지가 들어 있고, 팩(153개)에는 그 관계가 없다. 팩은 운영자가 손댄 사본이라
수치도 믿을 수 없다. 그래서 **구조는 원작에서, 이름만 사람이 채운다.**
...
def main():
    ...
    lines = [
        "# 기술·마법 한글 이름 — 사람이 채운다.",
        "# 구조(선행·직업·갈래)는 원작 영문 표가 정답지다: data/game-data/abilities.json",
        "# 팩(5.99)의 82·71 은 운영자가 손댄 사본이라 쓰지 않는다. 이름만 필요하다.",
        "#",
