...
MAPS = [
    ...
    20015,  # 우드랜드1-1
    # 2026-09-24 사용자: "우드랜드 맵이 왜 1-1 밖에 없어" — 서버에는 입구에서 이어지는 14맵이 다 있고 그림만 없었다
    20028,  # 우드랜드입구 — 1-1·1-2·1-3·2-1·3-1·4-1·5-1·6-1·14-1 로 가는 문이 여기 있다
    20016, 20017,  # 우드랜드1-2 · 1-3
    20022, 20023, 20024, 20025, 20026, 20020,  # 우드랜드2-1 · 3-1 · 4-1 · 5-1 · 6-1 · 14-1
    20018, 20019, 20027, 20021,  # 우드랜드10-1 · 11-1 · 6-1(진) · 14-1(진) — 입구와 이어진 문은 없다
    20263, 20264, 20265, 20266, 20267, 20268, 20269,  # 포테의숲 1~6존 · 보스존 (docs/pote-forest.md)
    20194, 20195,  # 숲오솔길 · 숲오솔길대기실 — 포테의숲 개인 던전 사본이 이 맵 번호를 알린다
    ...
    20138,  # 뮤레칸의방 — 죽으면 10,9 로 온다(LoruleConfig DeathMap)
    # 2026-09-24 월드맵에 다시 연 마을 셋과 그 워프로 닿는 곳
    20287,  # 밀레스마을
    20285, 20286, 20288, 20289, 20290, 20291, 20292, 20293, 20294, 20295, 20296, 20297, 20298,  # 밀레스 건물 13
    20030,  # 아벨마을
    20029, 20031, 20032, 20038, 20039, 20040, 20041, 20042, 20043,  # 아벨 건물 9
    20595, 20584, 20585, 20586, 20587, 20588, 20589, 20590, 20591, 20592, 20593, 20594,  # 아벨해안대기실 · 아벨해안 1~4
    20304,  # 마인마을
